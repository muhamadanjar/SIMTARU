...
<html>
    <head>
        ...
        {!! Html::style('editor/css/theme/dbootstrap/dbootstrap.css') !!}
        {!! Html::style('editor/css/main.css') !!}
    </head>
    <body class="dbootstrap">
        ...
        <script type="text/javascript">
            var dojoConfig = {
                ...
                packages: [{
                    name: 'viewer',
                    location: location.pathname.replace(/[^\/]+$/, '') + 'editor/js/viewer'
                },{
                    name: 'config',
                    location: location.pathname.replace(/[^\/]+$/, '') + 'editor/js/config'
                },{
                    name: 'gis',
                    location: location.pathname.replace(/[^\/]+$/, '') + 'editor/js/gis'
                }]
            };
        </script>
        <!--[if lt IE 9]>
