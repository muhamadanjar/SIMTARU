define([
    ...
    return {
        ...
        title: 'Peta Dasar', // tilte for widget
        ...
        basemapsToShow: ['streets','satellite', 'rupabumi'],
        ...
        basemaps: { // agol basemaps
            ...
            bogor: {
                ...
                basemap: new Basemap({
                    id: 'bogor',
                    layers: [new BasemapLayer({
                        url: 'http://localhost:6080/arcgis/rest/services/BOGOR/PETA_ADMINISTRASI_KABUPATEN_BOGOR_PUBLISH/MapServer'
                    })]
                })
            },
            satellite: {
